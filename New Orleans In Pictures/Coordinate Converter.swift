...
class CoordinateConverter {
    ...
    func packCoordinate(coordinate: CLLocationCoordinate2D) -> UInt64 {
     ...
     class func unpackCoordinate(_ packedCoordinate: UInt64) -> CLLocationCoordinate2D {
        return CLLocationCoordinate2DMake(unpackLatitude(packedCoordinate), unpackLongitude(packedCoordinate))
    }

    fileprivate class func unpackLatitude(_ packedCoordinate: UInt64) -> CLLocationDegrees {
    ...
    fileprivate class func unpackLongitude(_ packedCoordinate: UInt64) -> CLLocationDegrees {
